...
const articles = [
{
title: "FEATURE: Do background para o foreground. ",
description: `Foi um honra ter sido um dos oradores desse workshop no INSTITUTO FOCO
e apresentar as várias portas para entrar no mundo do desenvolvimento web,
no meu caso com ênfase para o hashtag#backend. Foi um workshop que contou com a participação
de vários jovens, uma sala cheia de energia e potencial,
foi uma experiência renovadora e extremamente empolgante. Baixe a cópia da apresentação <a target="_blank" href="https://docs.google.com/presentation/d/1b6s0v6JXn67lzlQDzeaNJPUPLjPwXS5n/edit?usp=sharing&ouid=100662677487505145459&rtpof=true&sd=true">AQUI</a>`,
link: "https://www.linkedin.com/posts/mamunhe_programaaexaetoweb-backend-foco-activity-7335190583704965120-CXft?utm_source=share&utm_medium=member_desktop&rcm=ACoAACeRQqQBF6GNH7Q3lMvmj8v9RAXmKNirxOE",
reactionCount: 75,
imageUrl: "assets/images/articles/workshop-2025/banner-pweb.jpeg",
imageAlt: "Programação web: Conceitos, Aprendizagem E desafios, Tecnologia e Áreas de Trabalho"
},
{
title: "'Breakdown' of the values NUIB brings to customers in this article",
